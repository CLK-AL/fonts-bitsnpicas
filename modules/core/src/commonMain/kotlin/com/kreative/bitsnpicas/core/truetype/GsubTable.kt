...
/**
 * The `GSUB` table — Glyph Substitution table (envelope only).
 *
 ...
 *
 * Full lookup parsing (single substitution, ligature, etc.) is deferred
 * to a follow-up.
 *
 * Spec: https://docs.microsoft.com/en-us/typography/opentype/spec/gsub
 */
public class GsubTable : TrueTypeTable() {

    override val tableName: String get() = "GSUB"
